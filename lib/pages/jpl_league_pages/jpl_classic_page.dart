// lib/pages/jpl_league_pages/jpl_high_stakes_page.dart

import 'package:flutter/material.dart';
import 'package:jersey_premier_league/main.dart';
import 'package:jersey_premier_league/services/league_service.dart';

class JPLClassicPage extends StatefulWidget {
  const JPLClassicPage({super.key});

  @override
  State<JPLClassicPage> createState() => _JPLClassicPageState();
}

class _JPLClassicPageState extends State<JPLClassicPage> {
  late Future<LeagueStandingsResponse> _standingsFuture;
  late final LeagueService _leagueService;
  final int leagueId = 92442;
  final String leagueName = 'JPL Season 9';
